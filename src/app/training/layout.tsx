      ...
      <nav className="hidden lg:flex fixed left-0 top-0 bottom-0 w-60 bg-black border-r border-white/10 flex-col py-6 z-40">
        <div className="px-5 mb-6">
          <Link href="/training/dashboard" className="block">
            <img src="/brand/logo.png?v=7" alt="NarvoQ" style={{ height: 64, width: 'auto', objectFit: 'contain' }} />
        ...
        <header className="px-5 py-3 border-b border-white/10 flex items-center justify-between lg:hidden">
          <div className="flex items-center gap-3">
            ...
            <Link href="/training/dashboard" className="shrink-0 active:scale-95 transition">
              <img src="/brand/logo.png?v=7" alt="NarvoQ" style={{ height: 70, width: 'auto', objectFit: 'contain' }} />
            </Link>
          </div>
